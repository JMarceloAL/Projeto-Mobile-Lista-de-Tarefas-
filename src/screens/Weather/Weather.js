...
import { ActivityIndicator, Button, StatusBar, Text, TextInput, TouchableOpacity, View } from "react-native";
    ...
    return (
        <View style={{ display: "flex", flex: 1, alignItems: "center", backgroundColor: "#f0eded" }}>
            ...
            {loading ? (
                ...
                <>
                    <View name="card" style={{ borderRadius: 30, backgroundColor: "white", height: 300, width: 300, alignItems: "center", padding: 20, marginTop: 20 }}>
                        <Text style={{ fontSize: 40, }}>{weatherData.name}</Text>

                        <Entypo name="icloud" size={50} color="black" style={{ marginTop: 20 }} />
